 ...
 * 阿里云 ARTC 会话连接的响应 DTO
 * 
 * <p>Contains the AliRTC App ID, Channel ID, User ID, and AuthInfo needed
 * for client-side connection via AliRTC Web SDK.</p>
 * 
 * @author Skylark Team
 * @version 1.0.0
 */
public class AliRTCConnectionResponse {
    ...
    public AliRTCConnectionResponse(String sessionId, String appId, String channelId,
                                     String userId, String authInfo, String status, String message) {
