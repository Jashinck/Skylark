...
│              com.bailing.application.service                 │
│              com.bailing.application.dto                     │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐      │
...
┌─────────────────────────────────────────────────────────────┐
│                   领域层 (Domain Layer)                       │
│                 com.bailing.domain.model                     │
│                com.bailing.domain.service                    │
│  ┌──────────────────────────────────────────────────────┐   │
│  │  领域模型 (Domain Models)                              │   │
│  │  - Dialogue (对话管理)                                 │   │
│  │  - Message  (消息实体)                                 │   │
...
│             com.bailing.infrastructure.adapter               │
│             com.bailing.infrastructure.config                │
│  ┌────────────────────────────────────────────────────┐     │
│  │  适配器 (Adapters)                                  │     │
...
### 1. API层 (API Layer) - `com.bailing.api`
...
### 2. 应用层 (Application Layer) - `com.bailing.application`
...
### 3. 领域层 (Domain Layer) - `com.bailing.domain`
...
### 4. 基础设施层 (Infrastructure Layer) - `com.bailing.infrastructure`
...
### 5. 公共层 (Common Layer) - `com.bailing.common`
